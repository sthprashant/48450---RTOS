/*********************************************************
   ----- 48450 -- week 7 lab handout 1 ------ 
This is a program to practice CPU Scheduling algorithm about shortest remaining time first (SRTF)
...
The Key point is to check which process is the SRTF at the next time unit. The competitions will 
occur if a new process jumps in. The CPU will assign one process (e.g.,1 of 8 processes) based on 
the smallest remaining_time (smallest bust_time) for the next time unit.   

Waiting Time = WT

P1 WT: 0-0=0 	after the check all the possiblities
P4 WT: 10-3=7	as above-mentioned
P5 WT: 18-16=2  as above-mentioned
P7 WT: 23-15=8 	as above-mentioned
P3 WT: 29-12=17	as above-mentioned
P8 WT: 41-30=11	as above-mentioned
P6 WT: 54-30=24	as above-mentioned
P2 WT: 73-7=66	as above-mentioned
*********************************************************/
